...
countSample <- 5
numSample <- 16
outPath <- "/Users/lindz/bigPint/tblshoot/RemSamples"
...
# Remove NP.2
beeCounts <- beeCounts[ , -which(names(beeCounts) %in% c("NP.2"))]

x <- DGEList(counts=beeCounts)
group <- as.factor(colnames(x))
group <- factor(c(rep("NC",6), "NP.1", "NP.3", "NP.4", "NP.5", "NP.6", rep("NR",6), rep("NS",6), rep("VC",6), rep("VP",6), rep("VR",6), rep("VS",6)))
x$samples$group <- group
lane <- as.factor(c("L12","L12","L12","L12","L34","L34","L12","L12","L12","L34","L34","L12","L12","L34","L34","L34","L34","L12","L12","L34","L34","L34","L34","L12","L12","L12","L12","L34","L34","L12","L12","L12","L12","L34","L34","L12","L12","L34","L34","L34","L34","L12","L12","L34","L34","L34","L34"))
x$samples$lane <- lane
```
...
Make boxplots
```{r}
ggparcoord(data.frame(x[[1]]), columns=1:47, alphaLines=0, boxplot=TRUE, scale="globalminmax") + coord_flip()
