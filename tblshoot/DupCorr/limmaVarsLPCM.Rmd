---
title: "Limma Extraneous variables duplicateCorrelation"
...
```
Trying Section 9.7 (Multi-level experiments) from limmaVoom vignette to account for confounding variables.
